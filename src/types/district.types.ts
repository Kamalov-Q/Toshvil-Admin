...
export const CreateDistrictSchema = z.object({
    ...
    hokimPhoto: z.string().url('Hokim photo must be a valid URL'),
    hokimDocumentUz: z.string().url('Document UZ must be a valid URL'),
    hokimDocumentRu: z.string().url('Document RU must be a valid URL'),
    hokimDocumentEn: z.string().url('Document EN must be a valid URL'),
